    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(config, new RoomOpenHelper.Delegate(4) {
      ...
      public RoomOpenHelper.ValidationResult onValidateSchema(
        ...
        if (!_infoReminders.equals(_existingReminders)) {
          return new RoomOpenHelper.ValidationResult(false, "reminders(com.example.voicereminder.data.model.ReminderEntity).\n"
                  + " Expected:\n" + _infoReminders + "\n"
                  + " Found:\n" + _existingReminders);
        }
        ...
        if (!_infoMissedReminders.equals(_existingMissedReminders)) {
          return new RoomOpenHelper.ValidationResult(false, "missed_reminders(com.example.voicereminder.data.model.MissedReminderEntity).\n"
