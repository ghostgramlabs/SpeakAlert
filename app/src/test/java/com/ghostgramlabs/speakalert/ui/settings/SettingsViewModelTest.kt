...
class SettingsViewModelTest {
    ...
    fun setup() {
        ...
        whenever(settingsRepository.experimentalVoiceEnhancementEnabled).thenReturn(MutableStateFlow(false))
    ...
    fun `setters forward values to settings repository`() = runTest {
        ...
        viewModel.setExperimentalVoiceEnhancementEnabled(true)
        ...
        verify(settingsRepository).setExperimentalVoiceEnhancementEnabled(true)
